...
// @grant        GM_getValue
// @grant        GM_setValue
// @downloadURL https://update.greasyfork.org/scripts/467079/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98Dplayer.user.js
// @updateURL https://update.greasyfork.org/scripts/467079/%E9%98%BF%E9%87%8C%E4%BA%91%E7%9B%98Dplayer.meta.js
// ==/UserScript==
...
(function() {
    ...
    obj.dPlayerStart = function () {
        ...
        var task_list = video_preview_play_info.quick_video_list;
    ...
    obj.get_video_preview_play_info = function (callback) {
        ...
        // 74ab3814-98a9-47ea-933c-85e56befec77
        // 27d3713fc8780e10eaa1a42c42c04b7c351c24bd1a637ea979116644a7fd12dc19820eff6c876912d23e991c38e1f6fe9669aa85864f02bbd695a72514cfb1d101
        // X-Device-Id
        const xDeviceId = "74ab3814-98a9-47ea-933c-85e56befec77";
        const xSignature = "27d3713fc8780e10eaa1a42c42c04b7c351c24bd1a637ea979116644a7fd12dc19820eff6c876912d23e991c38e1f6fe9669aa85864f02bbd695a72514cfb1d101";
        $.ajax({
            type: "post",
    ...
    obj.addCueVideoSubtitle = function (callback) {
        obj.getSubList(function (sublist) {
            if (sublist && sublist.length && sublist[0]) {
                ...
                sublist = [getLastElement(sublist)]
                ...
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    if (responseURL.endsWith("/file/get")) {
                        ...
                        if (response instanceof Object) {
                            ...
                            if (list && list[0].hasOwnProperty("preview_url")) {
